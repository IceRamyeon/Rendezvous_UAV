classdef RDPG < handle
    ...
    methods
        function obj = RDPG(k_gain, limit_G, r_allow, rate_limit, dt, init_sigma_rad, test_mode)
            obj.k = k_gain;
        ...
        function [acc_cmd, sigma_ref_new] = compute_commandRDPG(obj, V_p, lambda_dot, sigma_p, r, sigma_t)
            % [Step 1] 최적 리드각 계산
            ...
            % [Step 3] DPG 명령 생성
            u_cmd = lambda_dot - obj.k * (sigma_p - sigma_ref_new);
            raw_acc = V_p * u_cmd;
